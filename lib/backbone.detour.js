...
(function() {
  ...
  Backbone.Detour = (function(_super) {
    ...
    Detour.prototype.buildRoute = function(opts) {
      ...
      _.each(this.paramsForRoute, function(pfr) {
        var comparator, prevVal, prevVals, pv, val, vals, _i, _len, _ref;
        prevVal = _this.previousValues[pfr.name];
        val = opts[pfr.name] === false ? pfr["default"] || false : opts[pfr.name] ? opts[pfr.name] : prevVal || pfr["default"] || false;
